#Day 62 of Udemy's 100 Days of Python programming course
...
class CafeForm(FlaskForm):
    ...
    power_outlet_rating = SelectField('Power outlet availability rating', 
...
def add_cafe():
    ...
    if form.validate_on_submit():
        data = [form.cafe.data, form.location.data, form.open_time.data, 
